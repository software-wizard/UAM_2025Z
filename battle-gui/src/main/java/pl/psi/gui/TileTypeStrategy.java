    ...
    public void apply(MapTile aMapTile, Point aPoint) {
        ...
        if (tile != null) {
            switch (tile.getType()) {
                ...
                case DAMAGE -> aMapTile.setBackground(tile.isPassable() ? Color.DARKORANGE : Color.ORANGE);
                case BUFF -> aMapTile.setBackground(tile.isPassable() ? Color.DARKBLUE : Color.BLUE);
                //narazie tak zostawiam
            }
        }
    }
