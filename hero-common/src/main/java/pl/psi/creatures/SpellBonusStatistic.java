...
{
    WEAKEN_ATTACK(toSpellNameFormat("Weaken Attack"), -5, 0, 0, 0, Range.closed(0, 0), 1, "Weaken attack spell bonus", false, false),
    EXTRA_ATTACK(toSpellNameFormat("Extra Attack"), 5, 0, 0, 0, Range.closed(0, 0), 1, "Extra Damage spell bonus", false, false),
    EXTRA_MOVE_RANGE(toSpellNameFormat("Extra Move Range"), 0, 0, 0, 10, Range.closed(0, 0), 1, "Extra Move Range spell bonus", false, false),
    NO_BONUS(toSpellNameFormat("Empty"), 0, 0, 0, 0, Range.closed(0,0), 0, "No bonus to the spell", false, false);
